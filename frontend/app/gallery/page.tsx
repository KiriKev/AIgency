...
export default function Gallery() {
    ...
    const artworkItems: ArtworkItem[] = prompts
        .filter((prompt): prompt is Prompt & { id: string } => typeof prompt.id === "string" && !!prompt.id)
        .map(prompt => {
        ...
        return (
            <div className="min-h-screen bg-background pt-16">
                ...
                <main className="w-full px-2 py-2 flex items-center justify-center">
                    <p className="text-foreground text-lg" data-testid="text-loading">Loading prompts...</p>
                </main>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-background pt-16">
                ...
                <main className="w-full px-2 py-8 flex flex-col items-center justify-center">
                    <p className="text-foreground text-lg mb-4" data-testid="text-empty">No prompts available yet</p>
                    <p className="text-foreground/60 text-sm" data-testid="text-empty-hint">
