  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <ScrollArea className="w-20 lg:w-24 border-l border-border/50 bg-card/30 shrink-0">
          <div className="p-2 border-b border-border/50 sticky top-0 bg-card/30 z-10">
