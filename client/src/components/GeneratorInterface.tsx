...
import { Sparkles, RefreshCw, Check, X, Image as ImageIcon, Upload } from "lucide-react";
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle>Cyberpunk Cityscape</CardTitle>
              <Badge variant="secondary" data-testid="badge-iterations">
          ...
          <CardContent>
            <div className="aspect-video bg-muted rounded-md flex items-center justify-center border-2 border-dashed mb-4">
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">Click generate to create your image</p>
              </div>
            </div>
