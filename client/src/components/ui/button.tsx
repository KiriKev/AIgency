    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          "border [border-color:var(--button-outline)] bg-transparent shadow-xs hover:bg-accent/20 hover:shadow-sm active:shadow-none",
        secondary: "border bg-secondary text-secondary-foreground border border-secondary-border hover:bg-secondary/90 hover:shadow-sm ",
        // Add a transparent border so that when someone toggles a border on later, it will not shift layout/size.
        ghost: "border border-transparent hover:bg-accent/40",
      },
