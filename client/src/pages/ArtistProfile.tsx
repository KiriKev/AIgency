...
import { ArrowLeft, Grid, UserPlus, Sparkles, Eye, Heart } from "lucide-react";
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                {artworks.map((artwork) => (
                  <div
                    key={artwork.id}
                    className="relative aspect-square rounded-lg overflow-hidden cursor-pointer group hover-elevate"
                    onClick={() => setLocation(`/generator/${artwork.id}`)}
